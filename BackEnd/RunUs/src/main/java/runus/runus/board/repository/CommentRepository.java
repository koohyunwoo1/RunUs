...
public interface CommentRepository extends JpaRepository<CommentEntity, Integer> {
    ...
    // 댓글 목록 + 닉네임
    @Query("SELECT new runus.runus.board.dto.CommentResponseDTO(c.commentId, c.boardId, c.parentId, c.userId, c.content, c.createdAt, c.updatedAt, COALESCE(u.nickname, 'undefined'), u.exp) " +
